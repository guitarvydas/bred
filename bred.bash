...
bdir=../bred
./fab/fab - Bred ${bdir}/bred.ohm ${bdir}/bredohm1.fab  --support=support.js <$1 >${pattern}.ohm
./fab/fab - Bred ${bdir}/bred.ohm ${bdir}/bredohm2.fab  --support=support.js <$1 >>${pattern}.ohm
./fab/fab - Bred ${bdir}/bred.ohm ${bdir}/bredohm3.fab  --support=support.js <$1 >>${pattern}.ohm
